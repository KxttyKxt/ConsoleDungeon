 ...
 * <p>
 * @ConsoleDungeonNote  I (kxttykxt) have made this class Static so that I need not create a new object inside every class of my own.
...
public class ConsoleColors {
     ...
     * color is NULL, or if it contains an invalid ANSI code, no formatting will
     * be applied.
     * @ConsoleDungeonNote I overloaded the above method to apply more text formatting after instead of the reset code.
     * @param bgColor ANSI String with the background color
     * @param textColor ANSI String with the text color
     * @param str Text String to apply color styles
     ...
     * @ConsoleDungeonNote I made this myself smile
     */
